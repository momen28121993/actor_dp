class UrlData {
   ...
   // Common path
  String actorUrl(String pageNum) {
    return 'https://api.themoviedb.org/3/person/popular?api_key=$apiKey&language=en-US&page=$pageNum';
  }
...
https://api.themoviedb.org/3/person/popular?api_key=ddfc3b78adda5d8d71f3a0ddab4c3581&language=en-US&page=1
